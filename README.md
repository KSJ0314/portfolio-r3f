...
- **Firestore 콘텐츠** : 프로필·기술·교육·수상·자격증등의 데이터를 Firebase에 저장하여 나타낸다. 데이터를 재사용하여 추후 이력서 웹과 연결하기 위함.
...
- **에셋 출처 표기** : 외부에서 다운받은 3D 에셋의 `CC-BY` 저작권을 표기하며 방문자가 상호작용(회전, 줌)하여 에셋을 확인할 수 있도록 모달 형태로 나타낸다.
